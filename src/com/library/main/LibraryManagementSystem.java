...
public class LibraryManagementSystem {
    public static void main(String[] args) {
        ...
        System.out.println("Login successful! You have access to the Employee Profile.");

        while (true) {
            System.out.println("\n1. Add Profile");
            System.out.println("2. View Profile");
            System.out.println("3. edit Profile");
            System.out.println("4. Return Profile");
            ...
            switch (choice) {
                ...
                case 2:
                    ...
                    if (books.isEmpty()) {
                        System.out.println("No Profile available in the library.");
                    } else {
                        for (Book b : books) {
                    ...
                    break;
                case 3:
                    System.out.println("Enter the Profile ID to edit: ");
                    int bookId = scanner.nextInt();
                    bookDao.update(bookId, false);
                    break;
                 // Inside the switch statement in the main method
                case 4:
                    System.out.println("Enter Profile name to return: ");
